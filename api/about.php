...
<main>
    <section class="about">
        <h2>About Me</h2>
        <p>
            I’m Casper David van Laar, an Msc student in computer science and AI with a strong focus on the intersection of AI, neuroscience, and consciousness studies. 
